        ...
        <div class="max-w-5xl mx-auto">
            <div id="capture-area" class="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">🚀 Stock Breakout Scanner</h1>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-sm font-semibold text-gray-700 uppercase text-right">Resistance</th>
                ...
                <div class="mt-6 pt-6 border-t border-gray-100 text-xs text-gray-400 flex justify-between">
                    <span>Generated by AI Stock Scanner</span>
